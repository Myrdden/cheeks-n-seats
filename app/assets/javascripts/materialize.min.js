...
_createClass(Pushpin,[{key:"destroy",value:function destroy(){this.el.style.top=null;this._removePinClasses();var index=Pushpin._pushpins.indexOf(this);Pushpin._pushpins.splice(index,1);if(Pushpin._pushpins.length===0){this._removeEventHandlers()}
...
if(userOnOpenEnd&&typeof userOnOpenEnd==='function'){userOnOpenEnd.call(_this71.dropdown,_this71.el)}};if(this.isMultiple){dropdownOptions.closeOnClick=!1}
